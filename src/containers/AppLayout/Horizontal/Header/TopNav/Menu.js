...
class Menu extends Component {
  ...
  render() {
    return (
      <div className="app-main-menu d-none d-md-block ml-auto">
        <ul className="navbar-nav navbar-nav-mega">
          ...
          <li className="nav-item mr-4">
            <NavLink className="prepend-icon" to="/home">
              <span className="nav-text"><IntlMessages id="sidebar.login"/></span>
            </NavLink>
          </li>
          <li className="nav-item mr-4">
            <NavLink className="prepend-icon" to="/home">
              <span className="nav-text"><IntlMessages id="sidebar.becomeabolter"/></span>
            </NavLink>
          </li>
